/*
PROYECTO NIM (DEVELOPER 1.3)
Notas de versión:
- condicion para que el usuario no pueda ingresar "0" en cantidad de elementos para pasar de turno
- funcion para determinar perdedor 
					...
					*monton3 = 7;
					...
					void imprimir_tablero(int monton1, int monton2, int monton3, string jugador1, string jugador2, int punteo1, int punteo2){
						...
						void jugar(){
							...
							bool juego_terminado = false, player_one_turn, perder = false;

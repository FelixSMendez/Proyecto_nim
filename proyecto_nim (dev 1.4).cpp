/*
PROYECTO NIM (DEVELOPER 1.4)
Notas de versión:
- Método de empate añadido
*/
#include <iostream>
using namespace std;
...
bool empate(int monton1, int monton2, int monton3, int linea, int cantidad){
	...
	if(linea == 3 && monton1 == 0 && monton2 == 0 && monton3 == cantidad){
		return true;
	}else if(linea == 2 && monton1 == 0 && monton2 == cantidad && monton3 == 0){
		return true;
	}else if(linea == 1 && monton1 == cantidad && monton2 == 0 && monton3 == 0){
		return true;
	}else{
		return false;
	}
